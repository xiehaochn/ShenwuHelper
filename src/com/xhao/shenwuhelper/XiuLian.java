...
public class XiuLian extends Activity implements OnClickListener {
	protected void onCreate(Bundle savedInstanceState) {
		...
		AdView adView_xiulian = new AdView(this, AdSize.FIT_SCREEN);

		// 获取要嵌入广告条的布局
		LinearLayout adLayout_xiulian=(LinearLayout)findViewById(R.id.adLayout_xiulian);

		// 将广告条加入到布局中
		adLayout_xiulian.addView(adView_xiulian);
		}
